...
// Project Name: hdmi_dyn_ppll
// Target Devices: Pango PG2L100H-6FBG676
// Tool Versions: PDS 2022.2-SP6.4
// Description:  
//      
// Dependencies: 
// 
...
//    assign byte_over_rx = (init_over_rx == 1'b0 || init_over == 1'b1) ? byte_over : 0;
    ...
    wire         sda_rx_in/*synthesis PAP_MARK_DEBUG="true"*/;
    wire         sda_rx_out/*synthesis PAP_MARK_DEBUG="true"*/;
    wire         sda_rx_out_en/*synthesis PAP_MARK_DEBUG="true"*/;  
    iic_dri #(
        ...
        .scl            (  iic_rx_scl         ),//output               scl,
        .sda_in         (  sda_rx_in          ),//input                sda_in,
        .sda_out        (  sda_rx_out         ),//output   reg         sda_out=1'b1,
        .sda_out_en     (  sda_rx_out_en      ) //output               sda_out_en
    );
    
    assign iic_rx_sda = sda_rx_out_en ? sda_rx_out : 1'bz;
    assign sda_rx_in = iic_rx_sda;
