...
`define	VGA_640_640_60FPS_27MHz
//---------------------------------
//	640 * 640
`ifdef	VGA_640_640_60FPS_27MHz
`define	H_FRONT	12'd0
`define	H_SYNC 	12'd5 
`define	H_BACK 	12'd5  
`define	H_DISP	12'd640 
`define	H_TOTAL	12'd650	
 				
`define	V_FRONT	12'd0 
`define	V_SYNC 	12'd5   
`define	V_BACK 	12'd5
`define	V_DISP 	12'd640  
`define	V_TOTAL	12'd650
`endif
