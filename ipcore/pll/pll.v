...
module pll (
    ...
    localparam real    STATIC_RATIO0    = 80.0; //@IPC int 1.0000,128.0000 
        
    localparam integer STATIC_RATIO1    = 108; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO2    = 43; //@IPC int 1,128 
    ...
    localparam integer STATIC_DUTY0     = 80; //@IPC int 2,255
    
    localparam integer STATIC_DUTY1     = 108; //@IPC int 2,255
    
    localparam integer STATIC_DUTY2     = 43; //@IPC int 2,255
